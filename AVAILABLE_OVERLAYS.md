...
Use these overlays in recording software (e.g. OBS). Size is described in (Width x Height) format.
...
- Lap Timer
    ...
    - Size: 480 x 270
- Pit Timer
    - http://localhost:3000/pit-timer
    - Size: 340 x 220
- Live Speed
    - http://localhost:3000/live-speed
    - Size: 310 x 365
- Fastest Lap (popup)
    - http://localhost:3000/fastest-lap
    - Size: 920 x 125
- Weather
...
- Leaderboard (Last Name version)
    ...
    - Size: 650 x 1390
- Driver Name
    - http://localhost:3000/driver-name
    - Size: 910 x 117
